...
- Set up single Node.js API service with Fastify
...
_This simplified architecture prioritizes MVP delivery while maintaining the core "hands on-prem, brains in-the-cloud" principle. Complex scaling patterns and advanced features are intentionally deferred until post-MVP validation._
