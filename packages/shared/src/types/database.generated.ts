  ...
  public: {
    Tables: {
      ...
      approval_policies: {
        ...
        Relationships: [
          {
            foreignKeyName: "approval_policies_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "customers"
            referencedColumns: ["id"]
      ...
      remediation_scripts: {
        ...
        Relationships: [
          {
            foreignKeyName: "remediation_scripts_device_id_fkey"
            columns: ["device_id"]
            isOneToOne: false
            referencedRelation: "devices"
            referencedColumns: ["id"]
